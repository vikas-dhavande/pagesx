...
const defaultSignUpContent = {
    image: {
        src: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1470",
        alt: "Minimalist space for new beginnings"
    },
    quote: {
...
export function AuthUI({ signInContent = {}, signUpContent = {} }: AuthUIProps) {
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2 bg-background">
      ...
      <div
        className="hidden md:block relative bg-cover bg-center transition-all duration-500 ease-in-out grayscale"
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-end p-2 pb-12">
            <blockquote className="space-y-4 text-center text-foreground px-8 bg-background/80 py-6 rounded-2xl backdrop-blur-sm border border-border">
              ...
              <cite className="block text-sm font-light text-muted-foreground not-italic uppercase tracking-widest">
